...
# Load data once
data_url = 'https://github.com/LeScott2406/OOTP/raw/refs/heads/main/FAMLBC.xlsx'
...
if player_type == "Pitcher":
    ...
    pitcher_columns = ['POS', 'Name', 'ORG', 'Lev', 'Age', 'T', 'WE', 'INT', 'G/F', 'VELO', 
    ...
    hitter_columns = ['POS', 'Name', 'ORG', 'Lev', 'Age', 'B', 'T', 'WE', 'INT', 'Hit Ability', 
